...
excel_object=Excel(path.excel_path,'userRegister')
...
row_sql='select max(Fuid) from t_user_info '
# print(test_case)
    ...
    def test_sendmcode(self,case):
         ...
         try:
            ...
            if case_id==2:
                ...
                self.assertEqual(before_max_row,after_max_row-1)#判断注册成功后数据库是否增加一行数据
            res='pass'
